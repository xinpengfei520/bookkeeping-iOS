...
static NSDictionary<NSString *, NSString *> *KKEnglishTable(void) {
    ...
    dispatch_once(&once, ^{
        table = @{
            ...
            @"未注册 Face ID 或 Touch ID。请到 iOS 设置中先注册": @"Face ID / Touch ID is not set up. Please enroll one in iOS Settings first.",
            @"应用未获得 Face ID 权限。请在 iOS 设置 → 隐私与安全 → Face ID 中允许本应用": @"This app hasn't been granted Face ID access. Allow it in iOS Settings → Privacy & Security → Face ID.",
            @"Face ID 已锁定。请用锁屏密码解锁后重试": @"Face ID is locked. Unlock the device with your passcode and try again.",
            @"未设置锁屏密码，无法启用面容解锁": @"A device passcode is required before Face ID can be enabled.",
            ...
            @"松开选择相册": @"Release to pick photos",
            @"识别中…": @"Recognizing…",
            @"正在理解内容…": @"Understanding…",
            @"正在识别账单…": @"Reading the bill…",
            @"没听清，请再试一次": @"Didn't catch that, try again",
            @"没听出金额，请补一下": @"Amount missing — please fill in",
            @"按住加号说出一笔账，例如：昨天打车花了35块": @"Hold + and say an entry, e.g. taxi 35 yuan yesterday",
            @"按住加号说出一笔账，左滑可选相册": @"Hold + to speak, or slide left for photos",
            @"语音识别暂时不可用，请检查麦克风或网络": @"Speech recognition unavailable. Check the mic or network.",
            @"没读到图片，请再试一次": @"Couldn't load the photos, try again",
            @"没识别到文字，请换一张更清晰的账单图": @"No text found. Try a clearer bill screenshot.",
            @"确认记账": @"Confirm entry",
            @"确认记账 %ld 笔": @"Confirm %ld entries",
            @"识别到 %ld 笔，点按可改，左滑删除": @"%ld entries — tap to edit, swipe to delete",
            @"未识别备注": @"No note",
            @"未选类别": @"No category",
            @"待补金额": @"Add amount",
            @"没识别出金额，请补一下": @"Amount missing — please fill in",
